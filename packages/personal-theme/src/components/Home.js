                ...
                <div className="text">
                    <svg viewBox="0 0 393.368 243.743" className="svg-content">
                        <defs>
                            ...
                            <stop offset="0" stopColor="#fedad4"/>
                            <stop offset="0.066" stopColor="#d8e2dc"/>
                            <stop offset="0.28" stopColor="#ffe5d9"/>
                            <stop offset="0.452" stopColor="#ffd7ba"/>
                            <stop offset="0.59" stopColor="#fec89a"/>
                            <stop offset="0.813" stopColor="#cfb1ac"/>
                            <stop offset="1" stopColor="#fec5bb"/>
                            </linearGradient>
                        </defs>
